'bug-combine-unlike-terms-make-constant-in-parentheses-mid-transf'

OVERVIEW
Project:          Unclassified
PI:               
Curriculum:       
Dates:            Jun 22, 2016 - Jun 22, 2016
Domain/LearnLab:  
Tutor:            
Description:      
...
Number of Unique Steps:       1,346
Total Number of Steps:        3,522
Total Number of Transactions: 7,212
Total Student Hours:              0.93
Knowledge Component Model(s): Default (42 knowledge components)
                              Single-KC (1 knowledge component)
                              Unique-step (774 knowledge components)
...
Acknowledgment:
   ...
   We used the
   'bug-combine-unlike-terms-make-constant-in-parentheses-mid-transf' dataset
   accessed via DataShop (Koedinger et al., 2010).

or

   We used the
   'bug-combine-unlike-terms-make-constant-in-parentheses-mid-transf' dataset
   accessed via DataShop (pslcdatashop.org).
