'bug-distribute-change-minus-sign-mid-transf'
...
Acknowledgment:
   ...
   We used the 'bug-distribute-change-minus-sign-mid-transf' dataset accessed
   via DataShop (Koedinger et al., 2010).

or

   We used the 'bug-distribute-change-minus-sign-mid-transf' dataset accessed
   via DataShop (pslcdatashop.org).
