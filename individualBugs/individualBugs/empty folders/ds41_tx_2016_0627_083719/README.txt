'bug-move-variable-same-sign-mid-transf'
...
Total Number of Transactions: 7,241
Total Student Hours:              0.61
...
Acknowledgment:
   ...
   We used the 'bug-move-variable-same-sign-mid-transf' dataset accessed via
